...
import DirectChatPanel from "@/components/chat/direct-chat";
...
const ChatPage = () => {
  ...
  // console.log(onlineCount, "online Count");
        ...
        {activeUserId && activeUser ? (
          ...
          <Card className="flex h-full items-center justify-center border-border/70 bg-card">
            <CardContent className="text-center">
              <UsersIcon className="mx-auto mb-3 w-12 h-12 opacity-55 text-muted-foreground" />
